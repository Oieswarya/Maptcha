...
In the the first phase, for the purpose of mapping the long reads to contigs, we use JEM-Mapper: https://github.com/TazinRahman1105050/JEM-Mapper/tree/beta-2.1
